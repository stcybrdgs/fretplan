...
interface CreateProjectModalProps {
  isOpen: boolean
  onClose: () => void
  onSave: (name: string, color: ProjectArea['color']) => void
}
...
export const CreateProjectModal: React.FC<CreateProjectModalProps> = ({
  ...
  const [color, setColor] = useState<ProjectArea['color']>('purple')
      ...
      <form onSubmit={handleSubmit} className='space-y-4'>
        ...
        <div>
          ...
          <input
            ...
            placeholder='e.g., Original Song #1, Jazz Standards'
          ...
          <div className='flex flex-wrap gap-2'>
            {colors.map((colorOption) => (
              <button
                ...
                type='button'
                onClick={() =>
                  setColor(colorOption.value as ProjectArea['color'])
                }
